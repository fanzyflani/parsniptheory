...
strip parsniptheory-freebsd-i386 parsniptheory-freebsd-amd64 parsniptheory-windows-i386.exe parsniptheory-linux-i386 parsniptheory-linux-armv6l && \
strip parsnipserver-freebsd-i386 parsnipserver-freebsd-amd64 parsnipserver-windows-i386.exe parsnipserver-linux-i386 parsnipserver-linux-armv6l && \
