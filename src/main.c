...
widget_t *menu_gen_widget(struct menu_data *mdat, const char *name)
{
	...
	g = gui_new(gui_label57_init, groot, groot->w, 7, "Alpha 8 - SHAREWARE - Spread to all your friends! Even though it's not finished!");
	g->sx = 0;
	g->sy = 0;
...
int main(int argc, char *argv[])
{
	...
	SDL_WM_SetCaption("Parsnip Theory - SHAREWARE (alpha 8)", NULL);
